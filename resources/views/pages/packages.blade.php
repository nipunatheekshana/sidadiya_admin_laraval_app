...
<div class="uk-container uk-container-medium uk-margin-top uk-margin-bottom">
    <div class="uk-child-width-1-2 uk-grid-small" uk-grid='mansonry:true'>
        ...
        <div class="uk-width-expand@m">
            {{-- Noti 01 --}}
            <div class="uk-card uk-card-default uk-card-body uk-card-small uk-text-centcer uk-margin-small-bottom">
                ...
                <p class="uk-text-right">
                    {{-- Delete pakage --}}
                    <button class="uk-button uk-button-small editicons"><i class="fa fa-trash"></i><br><span style="font-size:10px">Delete</span>
                    </button>
                    {{-- Edit package --}}
                    ...
                    {{-- Deactivate --}}
                    <button class="uk-button uk-button-small editicons"><i class="fas fa-ban"></i><br><span style="font-size:10px">Deactive</span>
                    </button>
